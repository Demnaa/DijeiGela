...
module.exports = class BankCommand extends Command {
  constructor(client) {
    super(client, {
      name: "bank",
      description: "საბანკო ოპერაციებზე წვდომა",
      category: "ECONOMY",
      ...
      command: {
        ...
        subcommands: [
          {
            trigger: "balance",
            description: "ბალანსის შემოწმება",
          },
          {
            trigger: "deposit <coins>",
            description: "ბანკის ანგარიშის შევსება",
          },
          {
            trigger: "withdraw <coins>",
            description: "მოხსენით ქოინები თქვენი ბანკის ანგარიშიდან",
          },
          {
            trigger: "transfer <user> <coins>",
            description: "გაუგზავნე თანხა სხვა მომხმარებელს",
          },
        ],
      },
      slashCommand: {
