...
module.exports = class DailyCommand extends Command {
  constructor(client) {
    super(client, {
      name: "daily",
      description: "მიიღეთ ყოველდღიური ბონუსი",
      category: "ECONOMY",
...
async function daily(user) {
  ...
  const embed = new MessageEmbed()
    ...
    .setDescription(
      `შენ მიღე ${ECONOMY.DAILY_COINS}${ECONOMY.CURRENCY} როგორც ყოველდღიურ ჯილდოდ \n` +
        `**Განახლებული ბალანსი:** ${userDb.coins}${ECONOMY.CURRENCY}`
    );
