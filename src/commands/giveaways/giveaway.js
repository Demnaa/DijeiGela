...
module.exports = class Giveaway extends Command {
  constructor(client) {
    super(client, {
      name: "giveaway",
      description: "გათამაშების ბრძანებები",
      category: "GIVEAWAY",
      command: {
        enabled: true,
        minArgsCount: 1,
        subcommands: [
          {
            trigger: "start",
            description: "გათამაშების დაწყება",
          },
          {
            trigger: "pause <messageId>",
            description: "გათამაშების შეჩერება",
          },
          {
            trigger: "resume <messageId>",
            description: "განაახლეთ შეჩერებული გათამაშება",
          },
          {
            trigger: "end <messageId>",
            description: "დაასრულე გათამაშება",
          },
          {
            trigger: "reroll <messageId>",
            description: "ხელახლა გათამაშება",
          },
          {
            trigger: "list",
            description: "გათამაშების სია",
          },
          {
            trigger: "edit",
            description: "გათამაშების დასრულება",
          },
        ],
      },
      slashCommand: {
