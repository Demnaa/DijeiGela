    ...
    super(client, {
      ...
      command: {
        ...
        subcommands: [
          {
            trigger: "coin",
            description: "აბრუნებს მონეტას heads ან tails",
          },
          {
            trigger: "text <input>",
            description: "აბრუნებს მოცემულ შეტყობინებას",
          },
        ],
      },
      slashCommand: {
...
const firstEmbed = (user) =>
  new MessageEmbed().setColor(EMBED_COLORS.TRANSPARENT).setDescription(`${user.username}, დაიწყო მონეტის სროლა`);

const secondEmbed = () => new MessageEmbed().setDescription("მონეტა ჰაერშია");
